...
function appendMessengerUser(senderId,user,currentCity,mod,timestamp){
  ...
  if(mod){
    var appendString = '<div class="userMiniContainer dark"><img src="'+user.profile+'" class="userMiniProfile"><div class="userContent"><div class="userTitle">'+fullName+'</div><div class="userCity">'+lastSeen+' - '+cityName+'</div><div class="userActions"><div data-action="sendMessengerUserMessage" data-senderId="'+senderId+'" class="sendMessageAction actionBtn">Message</div><div data-action="sendMessengerUserMessage" data-senderId="'+senderId+'" class="sendOfferAction actionBtn">Send Offer</div></div></div></div>';
  }else{
    var appendString = '<div class="userMiniContainer dark"><img src="'+user.profile+'" class="userMiniProfile"><div class="userContent"><div class="userTitle">'+fullName+'</div><div class="userCity">'+lastSeen+' - '+cityName+'</div><div class="userActions"><div data-action="sendMessengerUserMessage" data-senderId="'+senderId+'" class="sendMessageAction actionBtn">Message</div><div data-action="sendMessengerUserMessage" data-senderId="'+senderId+'" class="sendOfferAction actionBtn">Send Offer</div></div></div></div>';
  }
